    ...
    <>
      <style>
        {`
            ...
            .user .welcome{
              font-size: 3em;
              color:${(style.theme==='light')?"#18042b":"#F9A826"};
            }
            .option{
              margin-top:2em;  
              font-size: 2em;
      ...
      <div className="home">
        ...
        >
          ...
          <path
            ...
            transform="translate(-110.33661 -237.5817)"
            fill={`${props.mode==='light'?'#F9A826':'#741AF4'}`}
          />
          <path
          ...
          <path
            ...
            fill={`${props.mode==='light'?'#ccc':'#A5A5A6'}`}
          />
          <circle cx="432.77633" cy="294.70402" r="4.24564" fill={`${props.mode==='light'?'#fff':'#D6D6D6'}`} />
          <circle cx="432.77633" cy="351.3125" r="4.24564" fill={`${props.mode==='light'?'#fff':'#D6D6D6'}`} />
          <circle cx="433.00385" cy="406.72228" r="4.24564" fill={`${props.mode==='light'?'#fff':'#D6D6D6'}`} />
          <path
          ...
          <path
            ...
            transform="translate(-110.33661 -237.5817)"
            fill={`${props.mode==='light'?'#fff':'#D6D6D6'}`}
          />
          <path
          ...
          <path
            ...
            transform="translate(-110.33661 -237.5817)"
            fill={`${props.mode==='light'?'#2F2E41':'#2A2A35'}`}
          />
          <polygon
